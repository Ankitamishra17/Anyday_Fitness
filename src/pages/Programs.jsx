          ...
          {programs.map((program, i) => {
            ...
            return (
              ...
              >
                {/* Image */}
                <div className="relative group order-2">
                  <div className="relative rounded-lg overflow-hidden border border-black/10 shadow-sm h-[320px] sm:h-[420px]">
                    <img
                      src={program.image}
                      alt={program.title}
                      loading="lazy"
                ...
                {/* Content */}
                <div className="flex flex-col gap-5 relative order-1">
                  <span className="absolute -top-6 -right-2 sm:-top-8 sm:-right-4 font-teko font-black text-[100px] sm:text-[140px] leading-none text-transparent [-webkit-text-stroke:1.5px_rgba(0,0,0,0.08)] select-none pointer-events-none z-0">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <div className="w-12 h-12 flex items-center justify-center rounded-full bg-primary/15 border border-primary/50 text-primary">
                    <Icon size={22} strokeWidth={1.75} />
                  ...
                  <div className="flex flex-wrap items-center gap-x-6 gap-y-3 py-5 border-y border-black/10">
                    <span className="flex items-center gap-2 text-xs font-rajdhani font-bold uppercase tracking-wide text-muted">
                      <Clock size={15} className="text-primary shrink-0" />
                      {program.duration}
                    </span>
