      ...
      <div className="container-x">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12 sm:mb-16">
          ...
          <div className="hidden sm:flex items-center gap-3 shrink-0">
            <button
              onClick={() => scroll("prev")}
              aria-label="Previous programs"
              className="w-12 h-12 flex items-center justify-center rounded-full border border-black/10 text-body hover:border-primary hover:text-primary hover:bg-primary/5 transition-all duration-300"
            >
              <ChevronLeft size={20} />
            </button>
            <button
        ...
        <div className="relative -mx-6 sm:mx-0">
          ...
          >
            {featured.map((program) => (
              <div
                key={program.id}
                className="shrink-0 w-full sm:min-w-[320px] sm:w-[320px] snap-start"
              >
                <ProgramCard program={program} />
              </div>
            ))}
        ...
        <div className="flex sm:hidden items-center justify-center gap-4 mt-8">
          <button
            onClick={() => scroll("prev")}
            aria-label="Previous programs"
            className="w-11 h-11 flex items-center justify-center rounded-full border border-black/10 text-body active:border-primary active:text-primary transition-colors"
          >
            <ChevronLeft size={18} />
          </button>
          <button
