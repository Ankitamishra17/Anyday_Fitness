...
export default function Footer() {
  return (
    <footer className="bg-surface border-t border-black/10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3 mt-1">
            {/* Facebook */}
             ...
             <a href="https://www.facebook.com/AnydayFitnessGreaterNoidaWest/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Visit our Facebook page"
              className="w-9 h-9 flex items-center justify-center rounded-full bg-surface2 border border-black/10 text-body hover:border-primary hover:text-primary transition-colors duration-300"
            >
              <FacebookIcon size={16} />
            </a>
            ...
            <a  href="https://www.instagram.com/anydayfitness_greaternoidawest?igsh=OHphZ3gxd2Z5bnBq&igsi=OHphZ3gxd2Z5bnBq"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Visit our Instagram page"
              className="w-9 h-9 flex items-center justify-center rounded-full bg-surface2 border border-black/10 text-body hover:border-primary hover:text-primary transition-colors duration-300"
      ...
      <div className="relative flex flex-col sm:flex-row items-stretch overflow-hidden border-t border-black/10">
        <div className="flex-1 px-5 sm:px-12 py-4 flex items-center justify-center sm:justify-start">
          <p className="font-inter text-xs text-muted">
            &copy; {new Date().getFullYear()} Anyday Fitness. All rights
            reserved.
