...
export default function TrainerCard({ trainer }) {
  ...
  return (
    <div className="group relative rounded-lg overflow-hidden border border-black/10 bg-surface shadow-sm hover:shadow-lg hover:border-primary/50 hover:-translate-y-1 transition-all duration-500">
      {/* Avatar zone */}
      <div className="relative h-56 sm:h-64 flex items-center justify-center overflow-hidden bg-surface2">
        {/* ambient backdrop */}
        <div
        ...
        <div className="absolute -inset-1 bg-primary/0 group-hover:bg-primary/5 transition-colors duration-500" />

        {/* letter avatar */}
        <div className="relative flex items-center justify-center w-24 h-24 sm:w-28 sm:h-28 rounded-full ring-2 ring-primary/40 group-hover:ring-4 group-hover:ring-primary transition-all duration-500 group-hover:scale-105 bg-white shadow-md">
          <span className="font-teko text-5xl sm:text-6xl font-semibold text-primary leading-none select-none">
            {initial}
          </span>
        </div>
        ...
        <div className="absolute top-4 right-4 flex flex-col gap-2 opacity-0 translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-400">
          {[FacebookIcon, InstagramIcon, YoutubeIcon].map((Icon, i) => (
             ...
             <a key={i}
              href="#"
              aria-label="social link"
              className="w-9 h-9 flex items-center justify-center rounded-full bg-white border border-primary/40 text-primary shadow-sm hover:bg-primary hover:text-black transition-colors duration-300"
            >
              <Icon size={15} />
            </a>
          ))}
