      ...
      <div className="container-x relative">
        ...
        >
          ...
          <div className="relative h-[320px] sm:h-[420px] lg:h-auto">
            ...
            />
            <div className="absolute bg-gradient-to-t from-bg/30 via-transparent to-transparent lg:bg-gradient-to-r lg:from-transparent lg:via-transparent lg:to-surface" />
          </div>
