      ...
      <div className="container-x">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-5">
          {amenities.map((a) => (
            <div
              key={a.title}
              className="group relative flex flex-col items-center text-center gap-3 rounded-xl border border-black/10 bg-surface p-5 sm:p-6 hover:border-primary/50 hover:-translate-y-1 transition-all duration-300"
            >
              <div className="w-12 h-12 flex items-center justify-center rounded-full bg-primary/10 text-primary group-hover:bg-primary group-hover:text-black transition-colors duration-300">
                <a.icon size={22} strokeWidth={1.75} />
              </div>
        ...
        {/* Equipment partners strip */}
        <div className="mt-14 sm:mt-16 flex flex-col sm:flex-row items-center justify-between gap-6 pt-10 border-t border-black/10">
          <span className="font-rajdhani font-bold uppercase tracking-[0.15em] text-xs sm:text-sm text-muted">
            Equipment Partners
          </span>
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-6">
